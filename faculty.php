...
<head>
  ...
  <title>FacultyLogin-Write Up!</title>
  <meta charset="utf-8">
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <a href="loginfac.php">Home</a>
    <a href="facultyprofile.php">My Profile</a>
...
<div class="row">
            <section class="col col-sm-6">
              <img src="faculties.jpg" alt="faculties">
            </section>
            ...
            <br><br>
              <h1>Hi,</h1>
                  ...
                  <button class="button"><span>View Submission</span></button>
                  </form>
                <br>
                <form action="post_assignment.php" method="POST">
                  <button class="button1"><span>Post Assignment</span></button>
                </form>
          </section>
</div>
<div style="text-align:center";>
