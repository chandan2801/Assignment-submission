...
<head>
<title>Student Submissions-Write Up!</title>
...
<br><br><br><br>
<div class="container">
<h1>The<span> submissions for assignments</span> for Assignment id <span><?php echo $assignmentid; ?></span> Subject <span><?php echo $subject; ?></span></h1>
<div id="body">
 <table width="80%" border="1" class="responstable">
    <tr>
    <th colspan="12">SEE THE SUBMISSIONS HERE!</th>
    </tr>
    <tr>
